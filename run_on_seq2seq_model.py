...
train_model(net_gru_huber,loss_type='huber',learning_rate=0.001, epochs=500, gamma=gamma, print_every=50, eval_every=50,verbose=1)
...
nets = [net_gru_mse,net_gru_mse_shape,net_gru_dilate, net_gru_huber]
