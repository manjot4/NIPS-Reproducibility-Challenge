...
def load_ECG5000(filepath_loc_train, filepath_loc_test):
    ...
    x_test_ip = test_data[500:5000, 0:84] 
    x_test_op = test_data[500:5000, 84:140]
...
def load_traffic(filepath):
    ...
    n = len(total_data)
    # tr = int(0.7)
    x_train_ip = total_data[:12000, 0:168] 
    x_train_op = total_data[:12000, 168:]
    # print x_train_ip.shape, x_train_op.shape

    x_test_ip = total_data[13000:17000, 0:168] 
    x_test_op = total_data[13000:17000, 168:]
    # print x_test_ip.shape, x_test_op.shape
    train_bkp = np.asarray([0]*12000)
